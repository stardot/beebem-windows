...
Root: HKLM; Subkey: "Software\Classes\BeebEm.adf\shell\open\command";          ValueType: string; ValueName: "";                ValueData: """{app}\BeebEm.exe"" -Model Master128 ""%1""";         Check: CheckAddFileAssociation('adf')
...
Root: HKLM; Subkey: "Software\Classes\BeebEm.ads\shell\open\command";          ValueType: string; ValueName: "";                ValueData: """{app}\BeebEm.exe"" -Model Master128 ""%1""";         Check: CheckAddFileAssociation('ads')
...
Root: HKLM; Subkey: "Software\Classes\BeebEm.adm\shell\open\command";          ValueType: string; ValueName: "";                ValueData: """{app}\BeebEm.exe"" -Model Master128 ""%1""";         Check: CheckAddFileAssociation('adm')
...
Root: HKLM; Subkey: "Software\Classes\BeebEm.adl\shell\open\command";          ValueType: string; ValueName: "";                ValueData: """{app}\BeebEm.exe"" -Model Master128 ""%1""";         Check: CheckAddFileAssociation('adl')
