...
#ifndef TOPWINDOW_HEADER
#define TOPWINDER_HEADER

#include "X11/Xlib.h"
#include "dagXCL/Window.h"

class TopWin : public dagXWindow {
public:
  TopWin(char *name,int x, int y, unsigned int width, unsigned int height,
         unsigned int border_width, int depth, unsigned int xClass,
         Visual *value, unsigned long valuemask, XSetWindowAttributes *attributes);
}; /* TopWin */
#endif
